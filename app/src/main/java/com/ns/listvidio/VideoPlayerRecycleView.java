...
public class VideoPlayerRecycleView extends RecyclerView {
    ...
    public VideoPlayerRecycleView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public VideoPlayerRecycleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        com.ns.listvidio.ViewHolder holder = (com.ns.listvidio.ViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
    ...
    private void animateVolumeControl(){
        if(volumeControl != null){
            ...
            if(volumeState == VolumeState.OFF){
                requestManager.load(R.drawable.ic_volume_off_grey24dp)
                        .into(volumeControl);
            }
            else if(volumeState == VolumeState.ON){
